...
class PolynomialExtractor:
    ...
    def interpolate_and_check_crc(self, vault: Vault, degree: int, crc_length, secret_length, 
                                  echo=False):
